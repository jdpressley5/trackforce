 ...
 * @editors Adam L.
 * Service for creating and verifying JWT tokens Based on the tutorial found here:
 * 		https://stormpath.com/blog/jwt-java-create-verify And resources from Sean Vaeth
...
public class JWTService {
	...
	/** Creates a token with an encoded username An expiration date has been set as well
	 * @return the token */
	 ...
	 * The front end handles errors differently depending on how old the token is.
	 * This method creates a JSON object to include in the response body which includes how long ago a JWT expired.
	 * @return -1 when the token was invalid or did not exist; else number of minutes since the token expired */
