...
public class InterviewService 
{
	 ...
	 * @param associateId
	 * @return */
	public List<TfInterview> getInterviewsByAssociate(int associateId) { return dao.getInterviewsByAssociate(associateId); }
	 ...
	 * <p>Note: if you leave some fields empty in the TfInterview parameter, it will be saved as such!</p>
	 * @version v6.18.06.13
	 * @param interview
	 * @return */
