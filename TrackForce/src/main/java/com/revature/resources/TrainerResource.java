...
public class TrainerResource 
{
	...
	public Response getBatchFromTrainer(@ApiParam("Trainer id") @PathParam("id") int id, @HeaderParam("Authorization") String token) 
	{
	...
	@Path("/{trainerId}")
	public Response updateTrainer(@PathParam("trainerId") Integer id, TfTrainer trainer, @HeaderParam("Authorization") String token) 
	{
		logger.info("updateTrainer()...");
		Claims payload = JWTService.processToken(token);

		if (trainer == null) return Response.status(Status.NO_CONTENT).build();
