...
public class TfUserAndCreatorRoleContainer implements Serializable 
{
	...
	public TfUserAndCreatorRoleContainer() { super(); }
	...
	public void setCreatorRole(int creatorRole) { this.creatorRole = creatorRole; }
	
	@Override
	public String toString() { return "TfUserAndCreatorRoleContainer [user=" + user + ", creatorRole=" + creatorRole + "]"; }
}